...
@section('content')
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-6 sm:mb-8">
        <div>
            ...
            <p class="text-gray-500 text-[14px]">Kelola profil dan keamanan akun Admin Lembaga Anda.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-sm shadow-sm border border-gray-200 p-6 text-center">
                ...
                <span class="inline-block bg-blue-100 text-blue-700 text-[10px] font-bold px-2.5 py-1 rounded-sm uppercase tracking-wider mt-2">
                    Admin Lembaga
                </span>
                ...
                <div class="mt-6 pt-5 border-t border-gray-100 space-y-3 text-left">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Lembaga</p>
                            <p class="text-[13px] text-gray-700 font-medium">{{ $user->lembaga ? $user->lembaga->nama_madrasah : '-' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-sm shadow-sm border border-gray-200">
                ...
                <form action="{{ route('setting.profile') }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
            ...
            <div class="bg-white rounded-sm shadow-sm border border-gray-200">
                ...
                <form action="{{ route('setting.password') }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    <div class="space-y-5">
                        <div>
