            ...
            <div class="flex-1 overflow-y-auto py-2 flex flex-col justify-between">
                ...
                <div class="pb-8 mt-12">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center gap-4 px-8 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="text-slate-500">
            ...
            <header
                ...
                <div class="ml-auto flex items-center gap-3 sm:gap-6">
                    <div class="flex items-center gap-3 sm:gap-4 text-gray-500">
                        ...
                        <!-- Settings -->
                        <a href="{{ route('setting') }}" class="hover:text-gray-700 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="hidden sm:block text-right">
                            ...
                            <p class="text-[10px] font-bold text-gray-400 mt-1 tracking-wide">Admin Lembaga</p>
                        </div>
