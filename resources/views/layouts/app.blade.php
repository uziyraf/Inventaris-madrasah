...
<body class="h-full antialiased text-gray-800 bg-[#f8fafc]">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside class="w-[280px] bg-white border-r border-gray-200 flex flex-col transition-all duration-300 z-20 shrink-0">
            <!-- Sidebar Header -->
            <div class="pt-8 pb-6 px-8">
                <h1 class="text-xl font-extrabold text-[#0f172a] tracking-tight">Manajer Inventaris</h1>
                <p class="text-[13px] font-medium text-slate-500 mt-1">Portal Institusi</p>
            </div>
            ...
            <div class="flex-1 overflow-hidden py-2 flex flex-col justify-between">
                <nav>
                    ...
                    <!-- Lembaga -->
                    <a href="{{ route('lembaga') }}" class="flex items-center gap-4 px-8 py-2.5 transition-colors {{ request()->routeIs('lembaga') ? 'bg-[#f0fbf7] text-[#1c7b5b] font-bold border-r-[3px] border-[#1c7b5b]' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{{ request()->routeIs('lembaga') ? '' : 'text-slate-500' }}"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>
                        Lembaga
                    </a>
                    ...
                    <!-- Inventaris -->
                    <a href="#" class="flex items-center gap-4 px-8 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-slate-500"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                        Inventaris
                    </a>

                    <!-- Manajemen Pengguna -->
                    <a href="{{ route('users') }}" class="flex items-center gap-4 px-8 py-2.5 transition-colors {{ request()->routeIs('users') ? 'bg-[#f0fbf7] text-[#1c7b5b] font-bold border-r-[3px] border-[#1c7b5b]' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{{ request()->routeIs('users') ? '' : 'text-slate-500' }}"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
                ...
                <div class="pb-8 mt-12">
                    <a href="#" class="flex items-center gap-4 px-8 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-slate-500"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                        Bantuan
                    </a>
                    <a href="#" class="flex items-center gap-4 px-8 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-slate-500"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
                        Keluar
                    </a>
                </div>
            </div>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#f4f7f6]">
            <!-- Topbar -->
            <header class="h-16 flex items-center justify-between px-8 bg-white border-b border-gray-200 z-10 sticky top-0 shrink-0">
                <!-- Search -->
                ...
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-4 text-gray-500">
                        ...
                        <button class="relative hover:text-gray-700 transition-colors">
                            ...
                            <span class="absolute top-0 right-0 block h-1.5 w-1.5 rounded-full bg-red-500 ring-2 ring-white"></span>
                        </button>
                        <!-- Settings -->
                    ...
                    <div class="flex items-center gap-3">
                        <div class="text-right">
                            ...
                            <p class="text-[10px] font-bold text-gray-500 uppercase mt-1 tracking-wider">ADMINISTRATOR</p>
                        </div>
                        <img src="https://ui-avatars.com/api/?name=Admin+User&background=1e293b&color=fff" alt="Admin" class="w-9 h-9 rounded-full border border-gray-200">
                    </div>
                </div>
            </header>
            ...
            <div class="flex-1 overflow-y-auto p-8 relative">
                ...
                <button class="fixed bottom-8 right-8 w-14 h-14 bg-[#1c7b5b] hover:bg-[#155d44] text-white rounded-xl shadow-lg flex items-center justify-center transition-colors z-50">
