        ...
        <aside
            ...
            <div class="pt-6 lg:pt-8 pb-5 lg:pb-6 px-5 lg:px-8 flex items-center justify-between gap-3">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        <h1 class="text-[17px] font-extrabold text-[#1e293b] tracking-tight leading-none truncate">Manajer Inventaris
                        </h1>
                        <p class="text-[11px] font-medium text-gray-400 mt-1 truncate">Portal Institusi</p>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto py-2 flex flex-col justify-between">
                <nav>
                    ...
                    <a href="{{ route('admin.laporan') }}"
                        class="flex items-center gap-4 px-8 py-2.5 transition-colors {{ request()->routeIs('admin.laporan') ? 'bg-[#f0fbf7] text-[#1c7b5b] font-bold border-r-[3px] border-[#1c7b5b]' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="{{ request()->routeIs('admin.laporan') ? '' : 'text-slate-500' }}">
                ...
                <div class="pb-8 mt-12">
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="w-full m-0 p-0">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center gap-4 px-8 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors text-left">
